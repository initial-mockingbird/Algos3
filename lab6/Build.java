...
public class Build {
	 ...
	 */
	static SimCity cargarSimCity(String nombreArchivo)
			throws IOException
	{
		SimCity salida;
	 ...
	 */
	private static void cargarLista(String linea, SimCity grafo)
	...
	{
		if(args.length < 1){
			throw new IllegalArgumentException("Uso: java Build <instancia>");
		}

		SimCity g = cargarSimCity(args[0]);
		System.out.println(g.reduceCity());
	}
}